              ...
              <div className="card-body">
                <div>
                  ...
                  <input
                    type="text"
                    id="idBookTitle"
                    className="form-control" onChange={(event) => setNewBook({...newBook, bookTitle: event.target.value})}
                  ></input>
                </div>
                <div>
                  ...
                  <input
                    type="text"
                    id="idBookAuthor"
                    className="form-control" onChange={(event) => setNewBook({...newBook, bookAuthor: event.target.value})}
                  ></input>
                </div>
                <div>
