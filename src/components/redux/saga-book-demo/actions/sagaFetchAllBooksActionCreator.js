import { SAGA_FETCH_ALL_BOOKS } from "./sagaActionTypes"

const sagaFetchAllBooksActionCreator = () => {
    return {
        type: SAGA_FETCH_ALL_BOOKS,
        payload: [
            {
              id: 101,
...
export default sagaFetchAllBooksActionCreator;